...
// Provider implementation. Application code imports `@/lib/ai/client`, which
// re-exports this behind a `server-only` guard; the evaluation harness runs
// outside Next.js and imports this module directly.
